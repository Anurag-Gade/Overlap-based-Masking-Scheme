...
overlap = 10  # Replace with the desired overlap (integer)
# num_sub_cubes_depth = 2  # Replace with the number of sub-cubes along the depth dimension (integer)
num_sub_cuboids_dim = {'num_sub_cuboids_x':10,
                      'num_sub_cuboids_y':10,
                      'num_sub_cuboids_z':8}
...
cube = create_cuboid(start_dict, end_dict, (132,132,90))
