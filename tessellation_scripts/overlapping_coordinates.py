...
def divide_cuboid(cuboid, total_num_sub_cuboids, overlap, num_sub_cubes_depth):
    ...
    for i in range(num_sub_cuboids_per_dim):
        for j in range(num_sub_cuboids_per_dim):
            for k in range(num_sub_cubes_depth):
                ...
                sub_cuboid_end = [(i + 1) * sub_cuboid_size[0] + overlap,
                                  (j + 1) * sub_cuboid_size[1] + overlap,
                                  (k + 1) * sub_cuboid_size[2] + overlap]
